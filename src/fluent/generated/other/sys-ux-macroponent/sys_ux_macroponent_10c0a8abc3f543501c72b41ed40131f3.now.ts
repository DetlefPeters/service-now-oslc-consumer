...
Record({
        ...
        data: `[
    {
        ...
        "elementId": "dynamic_routing_list",
        "elementLabel": "Dynamic Routing List",
        "eventMappings": [],
        "inputValues": {
            "routeConfigId": {
                "binding": {
    ...
    {
        "definition": {
            "id": "e56aae0873231010a0a79329faf6a768",
            "type": "CLIENT_STATE"
        },
        "elementId": "list_navigation_information",
        "elementLabel": "List Navigation Information",
        "eventMappings": [
            {
                "eventMappingId": "ckgcrggcocaaaabbfddghhaeeaaypsffvff",
                "isConfiguration": false,
                "offRowStorageId": null,
                "sourceEventApiName": "sn_record_list_con.SN_LIST_NAVIGATION_CLIENT#PROPERTY_CHANGED",
                "sourceEventDefinition": {
                    "apiName": "sn_record_list_con.SN_LIST_NAVIGATION_CLIENT#PROPERTY_CHANGED",
                    "id": null,
                    "type": "UXEVENT"
                },
                "sourceEventSysId": null,
                "targets": [
                    {
                        "broker": null,
                        "clientScript": {
                            "sysId": "20c0a8ebc3f543501c72b41ed40131fe"
                        },
                        "declarativeAction": null,
                        "event": null,
                        "operation": null,
                        "targetId": "ckgcrggcodaaaabbgddghhacaaaitmffo",
                        "type": "CLIENT_SCRIPT"
                    }
                ]
            },
            {
                "eventMappingId": "ckgcrffeeqcaaaabbdddghhamdzpeqmdd",
                "isConfiguration": false,
                "offRowStorageId": null,
                "sourceEventApiName": "sn_record_list_con.SN_LIST_NAVIGATION_CLIENT#PARAMS_UPDATE_REQUESTED",
                "sourceEventDefinition": {
                    "apiName": "sn_record_list_con.SN_LIST_NAVIGATION_CLIENT#PARAMS_UPDATE_REQUESTED",
                    "id": null,
                    "type": "UXEVENT"
                },
                "sourceEventSysId": null,
                "targets": [
                    {
                        ...
                        "declarativeAction": null,
                        "event": {
                            "apiName": "x_1937158_myarchim.CONTENT_UPDATED_RELAY_10c0a8abc3f543501c72b41ed40131f3",
                            "payload": {
                                "script": {
                                    "apiVersion": "1.0.0",
                                    "inlineScript": "/**\\n* @param {params} params\\n* @param {api} params.api\\n* @param {any} params.event\\n* @param {any} params.imports\\n*/\\nfunction evaluateEvent({api, event}) {\\n\\treturn {\\n    params: {\\n\\t\\t\\ttinyId: event.payload.tinyId,\\n\\t\\t\\tlistId: event.payload.listId\\n\\t\\t}\\n  };\\n}"
                                },
                                "type": "CLIENT_TRANSFORM_SCRIPT"
                            },
                            "sysId": "60c0e8ebc3f543501c72b41ed4013114"
                        },
                        "operation": null,
                        "targetId": "ckgcrffeeqeaaaabbeddghhaspqcnhml",
                        "type": "EVENT"
                    }
                ]
            }
    ...
    {
        "definition": {
            "id": "83114bc453231010c495ddeeff7b12d9",
            "type": "COMPOSITE"
        },
        "elementId": "getListPreferences",
        "elementLabel": "Get List preferences",
        "eventMappings": [
            {
                "eventMappingId": "ckkeqleeffraaaaanddghhzvjccnhhzcck",
                "isConfiguration": false,
                "offRowStorageId": null,
                ...
                "targets": [
                    {
                        ...
                        "event": null,
                        "operation": null,
                        "targetId": "ckkeqleeffraaaaaoddghhzfartazsq",
                        "type": "CLIENT_SCRIPT"
                    }
                ]
            }
    ...
    {
        "definition": {
            "id": "0b84084c536910105a20ddeeff7b124b",
            "type": "GRAPHQL"
        },
        "elementId": "setListPreference",
        "elementLabel": "Set List preference",
        "eventMappings": [],
        "inputValues": {},
        "readEvaluationMode": "EXPLICIT"
    },
    {
        ...
        "eventMappings": [
            {
                "eventMappingId": "cknknibbrggaaaaccddddghhvaffkdbtfk",
                "isConfiguration": false,
                "offRowStorageId": null,
                "sourceEventApiName": "sn_uxf.DATA_FETCH_SUCCEEDED",
                "sourceEventDefinition": {
                ...
                "targets": [
                    {
                        "broker": null,
                        "clientScript": {
                            "sysId": "acc0e8ebc3f543501c72b41ed4013102"
                        },
                        "declarativeAction": null,
                        "event": null,
                        "operation": null,
                        "targetId": "cknknibbrggaaaacceeddghhvdephkccia",
                        "type": "CLIENT_SCRIPT"
                    }
                ]
            }
        ...
        description:
            "Organizes a user's assigned records. List categories provide specific groups to help users sort and find specific records easily. You can tailor the list to show specific items depending on the user's role. You can create filtered lists with select list columns and assign the list to specific teams to help them focus their efforts. This template includes the list menu, which appears in the left pane to provide additional navigation capabilities for default lists and lists created by the user. The list page template is intended for use in large displays as a fullscreen experience.",
        disable_auto_reflow: 'false',
        dispatched_events:
            '5dd4f4050f121010036a83fa68767eb6,93e48589a9ee4a69f8d3f5d45ffeb05d,5dd4f4050f121010036a83fa68767eb6,93e48589a9ee4a69f8d3f5d45ffeb05d,2cc0e8ebc3f543501c72b41ed401310d,60c0e8ebc3f543501c72b41ed4013114,e4c0e8ebc3f543501c72b41ed4013163',
        extends: '19be392623033300f4b4c50947bf65ba',
        form_factors: '{}',
        handled_events:
            'f7d18e2cb7735010cd8af8e32e11a90b,8c1321d50f1310107d20409dc4767e52,2640a5150f1310107d20409dc4767e8a',
  ...
  "comment" : ""
    ...
    },
    {
        ...
        "label": "listDividerPosition",
        "name": "listDividerPosition",
        "shape": "",
        "valueType": ""
    },
    {
        ...
        "initialValue": {
            "type": "JSON_LITERAL",
            "value": "workspace.layout.listMenuRatio"
        },
        "label": "listRatioPreference",
        "name": "listRatioPreference",
        "shape": "",
        "valueType": ""
    },
    {
        ...
        "initialValue": {
            "type": "JSON_LITERAL",
            "value": "workspace.layout.listMenuOpen"
        },
        "label": "listMenuOpenPreference",
        "name": "listMenuOpenPreference",
        "shape": "",
        "valueType": ""
    },
    {
        ...
        "initialValue": {
            "type": "JSON_LITERAL",
            "value": "workspace.layout.listMenuRatio,workspace.layout.listMenuOpen"
        },
        "label": "listPreferences",
    ...
    },
    {
        ...
        "label": "listDisplayPanes",
        "name": "listDisplayPanes",
        "shape": "",
        "valueType": ""
    },
    {
